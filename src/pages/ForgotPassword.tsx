...
const ForgotPassword: FunctionComponent = () => {
  return (
    <div className="w-full relative bg-neutrals overflow-hidden flex flex-row items-start justify-start py-[6.5rem] pr-[6.375rem] pl-[6.5rem] box-border gap-[6.5rem] leading-[normal] tracking-[normal] text-left text-[0.875rem] text-blackish-green font-montserrat-medium-14 lg:flex-wrap lg:gap-[3.25rem] lg:pl-[3.25rem] lg:pr-[3.188rem] lg:box-border mq750:gap-[1.625rem] mq750:pl-[1.625rem] mq750:pr-[1.563rem] mq750:box-border">
      <div className="w-[32rem] flex flex-col items-start justify-start gap-[3rem] min-w-[32rem] max-w-full lg:flex-1 mq750:gap-[1.5rem] mq750:min-w-full">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[1rem]">
          ...
          <h1 className="m-0 relative text-[2.5rem] font-bold font-tradegothic-bold-16 text-black mq450:text-[1.5rem] mq1050:text-[2rem]">
        ...
        <div className="self-stretch h-[8.5rem] flex flex-col items-start justify-start gap-[2rem] max-w-full text-gray-300 mq750:gap-[1rem]">
          ...
          <button className="cursor-pointer [border:none] p-0 bg-[transparent] self-stretch flex flex-col items-start justify-start">
            <div className="self-stretch rounded bg-mint-green flex flex-row items-center justify-center py-[0.968rem] px-[1.25rem]">
              <div className="relative text-[0.875rem] font-semibold font-montserrat-medium-14 text-blackish-green text-left inline-block min-w-[3.313rem]">
                Submit
              </div>
            </div>
          </button>
        </div>
        <div className="self-stretch flex flex-row items-start justify-start gap-[1rem] text-gray-500 mq450:flex-wrap">
