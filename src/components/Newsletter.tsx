...
const Newsletter: FunctionComponent<NewsletterType> = ({ className = "" }) => {
  return (
    <div
      className={`w-[77rem] shadow-[0px_4px_16px_rgba(17,_34,_17,_0.05)] rounded-xl bg-lightcyan overflow-hidden flex flex-row items-end justify-between py-[0rem] px-[1.5rem] box-border max-w-full shrink-0 gap-[1.25rem] text-left text-[2.75rem] text-blackish-green font-tradegothic-bold-16 mq1225:flex-wrap ${className}`}
    >
      <div className="w-[37.063rem] flex flex-col items-start justify-between py-[1.5rem] px-[0rem] box-border min-w-[37.063rem] min-h-[19.063rem] max-w-full mq750:min-w-full mq1225:flex-1">
        <h1 className="m-0 w-[22.75rem] relative text-inherit leading-[3.375rem] font-bold font-inherit inline-block max-w-full mq750:text-[2.188rem] mq750:leading-[2.688rem] mq450:text-[1.625rem] mq450:leading-[2rem]">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[1rem] max-w-full text-[1.25rem] text-gray-700">
          <div className="flex flex-col items-start justify-start gap-[0.5rem]">
            <h3 className="m-0 w-[7.313rem] relative text-inherit font-bold font-inherit inline-block mq450:text-[1rem]">
              The Travel
            </h3>
